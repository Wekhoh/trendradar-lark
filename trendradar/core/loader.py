...
def _load_crawler_config(config_data: Dict) -> Dict:
    ...
    return {
        ...
        "PLATFORMS_API_URL": _get_env_str("PLATFORMS_API_URL")
...
def _load_ai_config(config_data: Dict) -> Dict:
    ...
    return {
        ...
        else ai_config.get("timeout", 120),
...
def _load_webhook_config(config_data: Dict) -> Dict:
    ...
    return {
        ...
        # 飞书应用 Bot（无自定义 webhook 时使用：tenant_access_token + im/v1/messages）
        "FEISHU_APP_ID": _get_env_str("FEISHU_APP_ID") or feishu.get("app_id", ""),
        "FEISHU_APP_SECRET": _get_env_str("FEISHU_APP_SECRET")
        or feishu.get("app_secret", ""),
        "FEISHU_CHAT_ID": _get_env_str("FEISHU_CHAT_ID") or feishu.get("chat_id", ""),
        "FEISHU_API_BASE": _get_env_str("FEISHU_API_BASE")
        or feishu.get("api_base", "https://open.larksuite.com"),
        # 钉钉
